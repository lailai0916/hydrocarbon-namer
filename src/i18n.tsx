...
const translations = {
  en: {
    ...
    'app.description': 'An interactive web app for drawing chain hydrocarbons and generating their systematic names.',
    'preference.switchLanguage': 'Switch language',
    'preference.toggleTheme': 'Toggle theme',
    'tool.select': 'Select',
  ...
  zh: {
    'app.title': '烃类命名器',
    'app.description': '用于绘制链状烃并生成系统命名的交互式网页应用。',
    'preference.switchLanguage': '切换语言',
    'preference.toggleTheme': '切换主题',
    'tool.select': '选择',
    'tool.addCarbon': '添加碳',
    'tool.singleBond': '单键',
    'tool.doubleBond': '双键',
